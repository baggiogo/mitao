...
-->
  <tr bgcolor="#FFFFFF"> 
    <td width="59%" class="titletd"><a href="$webdb[www_url]/bencandy.php?fid=$rs[fid]&id=$rs[id]&city_id=$rs[city_id]" target="_blank">$rs[title]</a></td>
    <td width="16%" align="center">$rs[posttime]</td>
    <td width="17%" align="center"><a href="$webdb[www_url]/list.php?fid=$rs[fid]&city_id=$rs[city_id]" target="_blank">$rs[fname]</a></td>
